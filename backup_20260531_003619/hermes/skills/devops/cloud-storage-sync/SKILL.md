...
See `references/phase5_6_sop.md` for a concrete Google Drive backup pipeline SOP, including `--sync-rclone` integration in `hermes_backup_master.py`, verification sequence, and restore pattern.
